...
import src.Biblioteca.helper.Utils;
...
public class Biblioteca {
  ...
  public static void Menu(){
      ...
      System.out.println("2 - cadastra Usuario");
    ...
    public static void cadastrarLivro(){
      ...
      Livro l1= new Livro(titulo,autor); //  Criando um novo  Objeto do tipo livro

        livros.add(l1); //Adicionando a lista livros

        System.out.println("📖 Livro cadastrdo com sucesso! 📖 \n");
    ...
    public static void listrarLivro(){
        for(Livro l: livros){
          ...
          public static void listrarUsuario(){
