  ...
  <div id="carouselExampleAutoplaying" class="carousel slide container my-5  " data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <img src="./img/esteira.jpeg" class="d-block w-100 rounded" alt="esteira">
      </div>

      <div class="carousel-item">
        <img src="./img/musculacao.jpeg" class="d-block w-100 rounded" alt="aparelho">
      </div>

      <div class="carousel-item">
        <img src="./img/piscina.jpeg" class="d-block w-100 rounded" alt="piscina">
      </div>

      <div class="carousel-item">
        <img src="./img/predio.jpeg" class="d-block w-100 rounded" alt="predio">
      </div>
